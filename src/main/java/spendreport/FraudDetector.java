...
public class FraudDetector extends KeyedProcessFunction<Long, Transaction, Alert> {
	...
	public void open(Configuration parameters) throws Exception {
		ValueStateDescriptor<Boolean> flagDescripter = new ValueStateDescriptor<>("flag", Types.BOOLEAN);
		flagstate = getRuntimeContext().getState(flagDescripter);

		ValueStateDescriptor<Long> timeDescripter = new ValueStateDescriptor<>("time", Types.LONG);
		timestate=getRuntimeContext().getState(timeDescripter);
	}
